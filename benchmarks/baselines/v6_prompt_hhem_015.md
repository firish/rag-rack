...
- **Pipeline:** `gemini/gemma-4-31b-it | bge-small | hybrid(BM25+lance) | min_tokens=100 | bge-rerank-v2-m3 | retrieve=80/rerank=8 | hhem-2.1-open@0.15 | balanced`
- **Run at:** 2026-05-13 02:12:51
- **Questions:** 29
...
| Metric | Value |
|---|---|
| `citation_precision` | 0.633 |
| `citation_recall` | 0.489 |
| `citation_f1` | 0.441 |
| `coverage` | 0.760 |
| `localization_accuracy` | 0.276 |
...
| `hp_potter_called_sorting` | ✗ | ✗ | 1 | 1 | 1 | 0.14 |
