...
- **Pipeline:** `gemini/gemma-4-31b-it | bge-small | hybrid(BM25+lance) | min_tokens=100 | bge-rerank-v2-m3 | retrieve=80/rerank=8 | no-verifier | loose`
- **Run at:** 2026-05-13 01:01:18
- **Questions:** 29
...
|---|---|---|---|---|---|---|
| `hp_quidditch_basics` | ✗ | ✗ | 1 | 5 | 3 | 0.35 |
| `hp_voldemort_killed_parents` | ✗ | ✗ | 1 | 1 | 4 | 0.48 |
| `hp_three_headed_dog_name` | ✗ | ✗ | 1 | 1 | 5 | 0.33 |
| `hp_hagrid_dragon_name` | ✗ | ✗ | 1 | 1 | 3 | 0.26 |
| `hp_mirror_of_erised` | ✗ | ✗ | 1 | 6 | 3 | 0.31 |
| `hp_why_famous` | ✗ | ✗ | 2 | 3 | 4 | 0.18 |
| `hp_hagrid_reveals_wizard` | ✗ | ✗ | 0 | 1 | 2 | 0.67 |
| `hp_platform` | ✗ | ✗ | 1 | 1 | 4 | 0.44 |
| `hp_sorcerers_stone` | ✗ | ✗ | 3 | 5 | 3 | 0.55 |
| `hp_sorting_hat_not_slytherin` | ✗ | ✗ | 2 | 3 | 2 | 0.41 |
| `hp_potter_called_sorting` | ✗ | ✗ | 1 | 2 | 1 | 0.30 |
| `hp_lily_james` | ✗ | ✗ | 0 | 1 | 2 | 0.36 |
| `hp_hogwarts_headmaster` | ✗ | ✗ | 1 | 1 | 4 | 0.25 |
| `hp_ollivander_wand_connection` | ✗ | ✗ | 1 | 1 | 1 | 0.41 |
| `hp_hagrid_first_name` | ✗ | ✗ | 1 | 1 | 2 | 0.28 |
| `hp_dudley_school` | ✗ | ✗ | 1 | 1 | 3 | 0.23 |
| `hp_four_houses` | ✗ | ✗ | 1 | 1 | 1 | 0.20 |
| `hp_ron_older_brothers` | ✗ | ✗ | 1 | 4 | 1 | 0.60 |
| `hp_learn_about_flamel` | ✗ | ✗ | 2 | 7 | 5 | 0.86 |
| `hp_scar_voldemort_connection` | ✗ | ✗ | 2 | 5 | 4 | 0.23 |
| `hp_quote_welcome` | ✗ | ✗ | 1 | 1 | 1 | 0.35 |
| `hp_quote_dwell_on_dreams` | ✗ | ✗ | 1 | 2 | 4 | 0.13 |
| `hp_refuse_dumbledore_plan` | ✓ | ✓ | 0 | 0 | 0 | 0.10 |
| `hp_refuse_petunia_lily_feelings` | ✗ | ✓ | 0 | 4 | 0 | 0.09 |
| `hp_steals_stone` | ✗ | ✗ | 0 | 3 | 3 | 0.48 |
...
> The three-headed dog is Fluffy.

Cited: sample-c7feccb8::s3877
...
### `hp_mirror_of_erised`
> The Mirror of Erised shows nothing more or less than the deepest, most desperate desire of our hearts. The happiest man on earth would look into it and see himself exactly as he is. Harry, who has never known his family, sees them standing around him. Ronald Weasley, who has always been overshadowed by his brothers, sees himself standing alone, the best of all of them. Dumbledore sees himself holding a pair of thick, woolen socks. Quirrell sees the Stone and presenting it to his master.

Cited: sample-c7feccb8::s4318, sample-c7feccb8::s4324, sample-c7feccb8::s4325, sample-c7feccb8::s4326, sample-c7feccb8::s4338, sample-c7feccb8::s5945
...
> Professor McGonagall said, "When I call your name, you will put on the hat and sit on the stool to be sorted" . Then "Potter, Harry!" was called .

Cited: sample-c7feccb8::s2436, sample-c7feccb8::s2478
...
> Mr. Ollivander tells Harry that the phoenix whose tail feather is in his wand gave another feather -- just one other. He says it is very curious indeed that Harry should be destined for this wand when its brother gave him that scar.
...
> They had indeed been searching books for Flamel's name ever since Hagrid had let it slip . Harry looked at the Famous Wizard card . He whispered, "I've found Flamel!" . The card stated that Dumbledore was famous for "his work on alchemy with his partner, Nicolas Flamel" . Hermione was dashing back, an enormous old book in her arms . She whispered that "Nicolas Flamel... is the only known maker of the Sorcerer's Stone!" . The book stated that the only Stone currently in existence belongs to Mr. Nicolas Flamel, the noted alchemist and opera lover .

Cited: sample-c7feccb8::s3958, sample-c7feccb8::s4410, sample-c7feccb8::s4416, sample-c7feccb8::s4418, sample-c7feccb8::s4422, sample-c7feccb8::s4430, sample-c7feccb8::s4438
...
> Aunt Petunia referred to Lily as her "dratted sister" . Aunt Petunia claimed she was the only one who saw Lily for what she was -- a freak . Aunt Petunia and Uncle Vernon normally pretended she didn't have a sister . It seemed Aunt Petunia had been wanting to say all this for years .

Cited: sample-c7feccb8::s1005, sample-c7feccb8::s1007, sample-c7feccb8::s1010, sample-c7feccb8::s117
