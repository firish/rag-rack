...
- **Pipeline:** `gemini/gemma-4-31b-it | bge-small | hybrid(BM25+lance) | min_tokens=150 | top_k=15 | loose`
- **Run at:** 2026-05-10 23:42:57
- **Questions:** 15
...
| Metric | Value |
|---|---|
| `citation_precision` | 0.292 |
| `citation_recall` | 0.371 |
| `citation_f1` | 0.266 |
| `coverage` | 0.750 |
