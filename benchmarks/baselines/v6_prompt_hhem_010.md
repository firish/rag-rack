...
- **Pipeline:** `gemini/gemma-4-31b-it | bge-small | hybrid(BM25+lance) | min_tokens=100 | bge-rerank-v2-m3 | retrieve=80/rerank=8 | hhem-2.1-open@0.1 | balanced`
- **Run at:** 2026-05-13 01:37:45
- **Questions:** 29
...
| Metric | Value |
|---|---|
| `citation_precision` | 0.611 |
| `citation_recall` | 0.489 |
| `citation_f1` | 0.427 |
| `coverage` | 0.760 |
| `localization_accuracy` | 0.241 |
| `abstention_precision` | 0.667 |
...
> Mr. Ollivander tells Harry that the phoenix whose tail feather is in his wand gave another feather -- just one other.
