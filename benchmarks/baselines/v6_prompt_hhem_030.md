...
- **Pipeline:** `gemini/gemma-4-31b-it | bge-small | hybrid(BM25+lance) | min_tokens=100 | bge-rerank-v2-m3 | retrieve=80/rerank=8 | hhem-2.1-open@0.3 | balanced`
- **Run at:** 2026-05-13 03:23:13
- **Questions:** 29
...
| `citation_recall` | 0.389 |
| `citation_f1` | 0.335 |
| `coverage` | 0.640 |
| `localization_accuracy` | 0.207 |
| `abstention_precision` | 0.444 |
...
| `hp_potter_called_sorting` | ✓ | ✗ | 0 | 0 | 1 | 0.14 |
...
| `hp_refuse_petunia_lily_feelings` | ✗ | ✓ | 0 | 1 | 0 | 0.16 |
...
> . Aunt Petunia claimed she was the only one who saw Lily for what she was -- a freak

Cited: sample-c7feccb8::s1007
